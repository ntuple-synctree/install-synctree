...
(@account_number, 'enterprise', @name, @email, usf_hash_passphrase(@crypt_key, @email, @passphrase), 1, 2, @register_date, NULL, NULL);
...
(2, @name, @email, usf_hash_passphrase(@crypt_key, @email, @passphrase), NULL, 1, 0, 1, @account_number, 1, @register_date, NULL, NULL);
